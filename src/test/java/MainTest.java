...
public class MainTest {
    ...
    public void testGetRawData(){
        ...
        String actual = main.getRawData();
        Assert.assertEquals(expected, actual);
    }

    @Test
    public void testGetWords(){
        ArrayList<String> expectedWords = allWords;
        ArrayList<String> actualWords = main.getWords();
    ...
    public void testCorrectCase(){
        ...
        expected.add("1/20/2020");
        ArrayList<String> actual = main.correctCase(input);
        Assert.assertEquals(expected, actual);
    }
    ...
    public void testGetAllWords(){
        ArrayList<String> expectedWords = allWords;
        ArrayList<String> actualWords = main.getAllWords();
        Assert.assertEquals(expectedWords, actualWords);
    }
}
